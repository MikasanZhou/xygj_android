...
public class MyWaveView2 extends View {
    ...
    //渐变背景的起始和结束颜色
    private int mGradientStartColor = Color.parseColor("#5461eb");
    ...
    public MyWaveView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mWavePath1.rQuadTo(w / 4, h / 6, w / 2, 0);
        mWavePath1.rQuadTo(w / 4, -h / 6, w / 2, 0);
        mWavePath1.rQuadTo(w / 4, h / 6, w / 2, 0);
        mWavePath1.rQuadTo(w / 4, -h / 6, w / 2, 0);
        ...
        mWavePath2.rQuadTo(w / 4, h / 6, w / 2, 0);
        mWavePath2.rQuadTo(w / 4, -h / 6, w / 2, 0);
        mWavePath2.rQuadTo(w / 4, h / 6, w / 2, 0);
        mWavePath2.rQuadTo(w / 4, -h / 6, w / 2, 0);
        mWavePath2.rQuadTo(w / 4, h / 6, w / 2, 0);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.save();
        canvas.translate(-getWidth() * mAnimProgress, getHeight() / 2.8f);
